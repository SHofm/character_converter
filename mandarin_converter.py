...
def generate_html(results: List[Dict], original_text: str, dark_mode: bool = False) -> str:
...
'''
    ...
    html_content += '''
        ...
        <footer>
            ...
            <p>💡 Tip: Klik op een woord om het te kopiëren. Hover voor meer informatie.</p>
        </footer>
    </div>
...
你喜欢吃什么？我喜欢吃米饭和蔬菜。"""
    ...
    html_output = generate_html(results, chinese_text)
